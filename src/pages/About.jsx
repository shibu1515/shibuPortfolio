            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6} data-aos="zoom-in">
                ...
                <Typography variant="body1" className="body1-variant" mt={2}>
                  ...
                  two years, I've worked on various projects ranging from small
                ...
                <Typography variant="body1" className="body1-variant" mt={2}>
                  I began my journey as a web developer in Dec 2021, and since then,
...
//       <Container maxWidth="lg">
//         <div className='about-div-2' data-aos="fade-up">
//           <div className='custom-download-cv-web-2' style={{ backgroundColor: "#3178C6" }} data-aos="fade-right">
//             <Typography variant='body1' className='body1-menu-variant' textAlign={"center"} color={"#FFFFFF"}>
//               About me
//             </Typography>
//           </div>
...
//                   and CSS. Over the past two years, I've worked on various projects ranging from small business websites
//                   to large-scale web applications. My focus is on writing clean, efficient code and continuously improving
//                   my skills.
//                 </Typography>

//                 <Typography variant='body1' className='body1-variant' mt={2}>
//                   I began my journey as a web developer in Dec 2021, and since then, I've continued to grow and evolve as
...
//                 <Typography variant='body1' className='body1-variant' mt={2}>
//                   You can find me hovering around Indeed, witnessing the journey of early startups. You can follow me on
//                   Indeed, where I share tech-related bites and build in public, or you can follow me on GitHub.
//                 </Typography>
...
//                 <Stack direction={"row"} gap={{ xs: 1, sm: 2 }} mb={3}>
//                   <ul className='ul-font-about' data-aos="fade-right">
//                     <li className='li-font-about'>B.E CSE Engineering</li>
//                     <li className='li-font-about'>Experience with Next.js</li>
//                   </ul>
//                   <ul className='ul-font-about' data-aos="fade-left">
