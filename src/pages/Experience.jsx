    ...
    return (
        <div style={{ backgroundColor: theme?.palette?.mode === "light" ? "#F9FAFB" : "#111827" }}>
            <Container maxWidth="lg" >
                ...
                <Box mt={5} >
                    <Typography variant='body2' className='body2-variant' textAlign={"center"} data-aos="fade-up">
                        Here is a quick summary of my most recent experiences:
                    </Typography>
                </Box>

                <Box mt={5} display={"flex"} justifyContent={"center"} >
                    <PaperStyle elevation={3} data-aos="fade-up">
                        <Grid container spacing={{ xs: 1, md: 2 }}>
                            ...
                            <Grid item xs={12} md={8}>
                                <Stack direction={{ xs: "column-reverse", md: "row" }} gap={{ md: 10, lg: 15 }}>
                                    <Typography variant='h2' className="h2-variant" mt={{ xs: 1, md: "unset" }} ml={{ xs: 0, md: 2 }} data-aos="fade-right">Frontend Developer Reactjs</Typography>
                                    <Typography variant="h6" className="h6-variant" mt={{ xs: 1, md: "unset" }} ml={{ xs: 0, md: "unset" }} data-aos="fade-left">July 2023 - present</Typography>
                                </Stack>

                                <Box paddingRight={{ md: 16, lg: 20 }}>
                                    <ul className='ul-experience'>
                                        <li className='li-experience' style={{ color: theme?.palette?.mode === "light" && "#4B5563" }} data-aos="fade-up">
                ...
                <Box mt={5} display={"flex"} justifyContent={"center"} >
                    <PaperStyle elevation={3} sx={{ marginBottom: "20px" }} data-aos="fade-up">
                        <Grid container spacing={{ xs: 1, md: 2 }}>
                            <Grid item xs={12} md={4} sx={{ display: "flex", alignItems: "center", justifyContent: 'center' }}>
                                <Box display={"flex"} justifyContent={{ xs: "flex-start", md: "center" }} >
                                    {
                            ...
                            <Grid item xs={12} md={8} >
                                <Stack direction={{ xs: "column-reverse", md: "row" }} gap={{ md: 10, lg: 15 }}>
                                    <Typography variant='h2' className="h2-variant" mt={{ xs: 1, md: "unset" }} ml={{ xs: 0, md: 2 }} data-aos="fade-right">Frontend Developer</Typography>
                                    <Typography variant="h6" className="h6-variant" mt={{ xs: 1, md: "unset" }} ml={{ xs: 0, md: "unset" }} data-aos="fade-left">Dec 2021 - Sep 2022</Typography>
                                </Stack>
                                <Box paddingRight={{ md: 16, lg: 20 }}>
                                    <ul className='ul-experience'>
                                        <li className='li-experience' style={{ color: theme?.palette?.mode === "light" && "#4B5563" }} data-aos="fade-up">
